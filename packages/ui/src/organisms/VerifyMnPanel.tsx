  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
        ...
        <p className="mt-1 rounded-lg bg-white px-3 py-2 text-base font-bold text-gray-900">{session.text}</p>
      </div>
      ...
      {isExpired ? (
        <button
          type="button"
          onClick={onRestart}
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gray-900 px-6 py-3.5 text-sm font-bold text-white transition-all hover:bg-gray-800"
        >
          Дахин эхлүүлэх
        </button>
      ) : (
