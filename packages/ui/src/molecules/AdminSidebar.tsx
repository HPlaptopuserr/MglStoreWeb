...
export function AdminSidebar({
  ...
  return (
    <>
      {/* Spacer that stays in the flex layout */}
      <div
        className={`${isCollapsed ? "w-[88px]" : "w-[260px]"} shrink-0 transition-all duration-300 hidden md:block`}
    ...
    `}
      >
        ...
        <div
          className={`mb-8 flex items-center ${isCollapsed ? "justify-center" : "gap-3 px-2"
            }`}
        >
        ...
        <div className="mt-6 border-t border-slate-100 pt-4">
          <div
            className={`rounded-2xl bg-slate-50 ${isCollapsed ? "p-2" : "p-4"
              } transition-all duration-300`}
          >
            <div
