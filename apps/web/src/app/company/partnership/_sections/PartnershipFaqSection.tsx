...
const FAQ_DATA: FAQData[] = [
  ...
  },
  {
    ...
    answer:
      "Тооцоог сар бүрийн тогтсон өдрүүдэд автоматаар нийлж, таны бүртгэлтэй данс руу шилжүүлнэ. Тайланг системээс татаж авах боломжтой. QR төлбөр, SocialPay болон бүх банкны картаар тооцоо нийлнэ.",
    icon: CreditCard,
    category: "Санхүү",
  },
  {
