...
import { MobileBankAppLinks, type PaymentDeepLink } from "./MobileBankAppLinks";

export type PaidAccessPaymentSession = {
  invoiceId: string;
...
type PaidAccessPaymentModalProps = {
  itemId: string;
  title: string;
...
export function PaidAccessPaymentModal({
  itemId,
  title,
  payment,
  checkUrl,
