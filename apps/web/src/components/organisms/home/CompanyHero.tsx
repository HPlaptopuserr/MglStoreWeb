...
import { Input } from "@mgl/ui";
import { Badge } from "@mgl/ui";
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Badge
                variant={company.isOpen ? "default" : "secondary"}
                className={`px-3 py-1 text-sm ${company.isOpen ? "bg-amber-500" : "bg-slate-100 text-slate-500"}`}
              >
