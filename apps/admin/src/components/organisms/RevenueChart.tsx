...
export function RevenueChart({
    ...
    return (
        <div className="lg:col-span-2 bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden transition-all duration-300 hover:shadow-lg flex flex-col min-h-[400px]">
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl overflow-x-auto max-w-full">
                    {ranges.map((range) => (
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all duration-300 whitespace-nowrap ${activeRange === range.value
