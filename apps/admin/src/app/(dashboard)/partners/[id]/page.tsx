    ...
    if (!partner) {
        return (
            <div className="min-h-screen bg-[#f8f9fa] p-8 flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Түнш олдсонгүй</h2>
                <p className="text-slate-500 mb-6">Таны хайсан түншийн мэдээлэл олдсонгүй эсвэл устгагдсан байна.</p>
                <button
                    onClick={() => router.back()}
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-3 mb-2">
                                    <h1 className="text-3xl font-bold text-slate-900 truncate">{partner.name}</h1>
                                ...
                                <div className="text-slate-500 text-lg mb-4">@{partner.slug}</div>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm font-medium text-slate-700">
                                        ...
                                        Бүртгүүлсэн: {new Date(partner.createdAt).toLocaleDateString("mn-MN")}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
                        <h3 className="text-lg font-bold text-slate-900 mb-6">Холбоо барих мэдээлэл</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-slate-500 mb-0.5">И-мэйл хаяг</p>
                                    <p className="text-slate-900 font-medium">{partner.email || "Бүртгэлгүй"}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-slate-500 mb-0.5">Утасны дугаар</p>
                                    <p className="text-slate-900 font-medium">{partner.phone || "Бүртгэлгүй"}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 md:col-span-2">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-slate-500 mb-0.5">Хаяг байршил</p>
                                    <p className="text-slate-900 font-medium leading-relaxed">{partner.address || "Бүртгэлгүй"}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 line-clamp-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100/50">
                                <p className="text-slate-500 text-sm font-medium mb-1">Хэрэглэгч</p>
                                <div className="text-2xl font-bold text-indigo-700">{partner.stats.users}</div>
                            </div>
                            <div className="bg-emerald-50/50 p-4 rounded-xl border border-emerald-100/50">
                                <p className="text-slate-500 text-sm font-medium mb-1">Бүтээгдэхүүн</p>
                                <div className="text-2xl font-bold text-emerald-700">{partner.stats.products}</div>
                            </div>
                            <div className="bg-amber-50/50 p-4 rounded-xl border border-amber-100/50">
                                <p className="text-slate-500 text-sm font-medium mb-1">Салбар</p>
                                <div className="text-2xl font-bold text-amber-700">{partner.stats.branches}</div>
                            </div>
                            <div className="bg-sky-50/50 p-4 rounded-xl border border-sky-100/50">
                                <p className="text-slate-500 text-sm font-medium mb-1">Захиалга</p>
                                <div className="text-2xl font-bold text-sky-700">{partner.stats.orders}</div>
                            </div>
                        </div>
                    </div>
                </div>
