          ...
          <div className="flex flex-wrap items-start justify-between gap-4 border-b border-slate-100 px-5 py-4 sm:px-6">
            <div>
              ...
              <h1 className="mt-1 text-2xl font-black tracking-tight text-slate-950">
                Сургалтын page удирдлага
              </h1>
              <p className="mt-1 max-w-3xl text-sm font-semibold leading-6 text-slate-500">
                Hero тохиргоо, сургалтын card, багш, хугацаа, хөтөлбөрийг нэг
                дороос удирдана.
              </p>
            </div>
            <a
          ...
          <div className="grid gap-px bg-slate-100 sm:grid-cols-3">
            ...
            <div className="bg-white px-5 py-4">
              ...
              <p className="mt-1 text-2xl font-black text-emerald-700">
                {
                  studyProjects.filter((project) => project.isActive !== false)
                    .length
                }
              </p>
            </div>
            <div className="bg-white px-5 py-4">
              ...
              <p className="mt-1 text-2xl font-black text-orange-600">
                {
                  studyProjects.filter(
                    (project) => Number(project.featuredOrder || 0) > 0,
                  ).length
                }
              </p>
            </div>
