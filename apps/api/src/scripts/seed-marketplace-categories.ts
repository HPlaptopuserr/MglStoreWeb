...
const MARKETPLACE_CATEGORIES: CategorySpec[] = [
  ...
  { slug: "traditional-clothing", name: "Үндэсний хувцас, дээл", icon: "🇲🇳", parentSlug: "fashion-beauty", sortOrder: 204 },
  { slug: "shoes-bags", name: "Гутал, цүнх", icon: "👟", parentSlug: "fashion-beauty", sortOrder: 205 },
  { slug: "jewelry-watches", name: "Гоёл чимэглэл, цаг", icon: "💍", parentSlug: "fashion-beauty", sortOrder: 206 },
  { slug: "beauty-skincare", name: "Арьс арчилгаа", icon: "🧴", parentSlug: "fashion-beauty", sortOrder: 207 },
  { slug: "makeup", name: "Нүүр будалт", icon: "💄", parentSlug: "fashion-beauty", sortOrder: 208 },
  { slug: "hair-care", name: "Үс арчилгаа", icon: "💇", parentSlug: "fashion-beauty", sortOrder: 209 },
  { slug: "perfume-fragrance", name: "Үнэртэн", icon: "🌸", parentSlug: "fashion-beauty", sortOrder: 210 },
  { slug: "personal-care", name: "Хувийн арчилгаа", icon: "🧼", parentSlug: "fashion-beauty", sortOrder: 211 },
  ...
  { slug: "beverage-juice-equipment", name: "Кофе, ундаа бэлтгэх төхөөрөмж", icon: "🥤", parentSlug: "kitchenware", sortOrder: 4099 },
  ...
  { slug: "building-materials", name: "Барилгын материал", icon: "🧱", parentSlug: "construction-tools", sortOrder: 1002 },
  { slug: "paint-finishing", name: "Будаг, өнгөлгөө", icon: "🎨", parentSlug: "construction-tools", sortOrder: 1003 },
  { slug: "plumbing-sanitary", name: "Сантехник", icon: "🚰", parentSlug: "construction-tools", sortOrder: 1004 },
  { slug: "heating-cooling", name: "Халаалт, агааржуулалт", icon: "♨️", parentSlug: "construction-tools", sortOrder: 1005 },
  { slug: "electrical-supplies", name: "Цахилгааны материал", icon: "🔌", parentSlug: "construction-tools", sortOrder: 1006 },
  { slug: "power-tools", name: "Цахилгаан багаж", icon: "🛠️", parentSlug: "construction-tools", sortOrder: 1007 },
  { slug: "safety-workwear", name: "ХАБЭА, ажлын хувцас", icon: "🦺", parentSlug: "construction-tools", sortOrder: 1008 },
