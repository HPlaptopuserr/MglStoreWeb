...
// ─── PUBLIC: Бүх идэвхтэй ангиллуудыг буцаана ─────────────────────────────
...
// ─── ADMIN: Бүх ангиллуудыг (идэвхгүйг ч бас) буцаана ──────────────────────
...
router.post("/admin/business-categories", async (req, res) => {
    try {
        ...
        if (existing) {
            return res.status(409).json({ message: "Ийм slug-тай ангилал аль хэдийн байна" });
        }
