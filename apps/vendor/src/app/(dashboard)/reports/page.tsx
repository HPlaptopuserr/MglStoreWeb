  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <p className="text-xs leading-5 text-slate-400">
        Боломжит ашиг нь одоогийн үлдэгдлийг бүртгэлтэй зарах үнээр бүрэн
        борлуулсан тооцоо. Авсан үнэ оруулаагүй бүтээгдэхүүн өртөг болон ашгийн
        дүнд 0-ээр тооцогдоно.
      </p>
    </div>
  );
}
